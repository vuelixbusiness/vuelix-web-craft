          ...
          <CardContent>
            <Tabs value={userType} onValueChange={value => setUserType(value as 'creator' | 'artist')}>
              ...
              <TabsContent value="creator">
                <div className="text-center mb-4 p-4 bg-card rounded-lg border border-border">
            ...
            <div className="space-y-3">
              <Button type="button" variant="outline" className="w-full hover:bg-accent hover:text-accent-foreground transition-smooth" onClick={handleGoogleSignIn} disabled={isLoading}>
              ...
              <Button type="button" variant="outline" className="w-full hover:bg-accent hover:text-accent-foreground transition-smooth" onClick={handleMicrosoftSignIn} disabled={isLoading}>
                <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24">
