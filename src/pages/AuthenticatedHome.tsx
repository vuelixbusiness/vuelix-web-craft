...
const AuthenticatedHome = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Generate some recent activity (in a real app, this would come from a proper activity log)
                ...
                <CardContent>
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      {user.membershipType === 'premium' 
                        ? 'Enjoy premium benefits and higher payouts!'
                        : 'Upgrade to VIP for better earning opportunities'
                      }
                    </p>
                    {user.membershipType !== 'premium' && (
                      <Link to="/vuelix-plus">
