  ...
  useEffect(() => {
    const handleCallback = async () => {
      try {
        ...
        if (error) {
          throw new Error(`PayPal connection failed: ${error}`);
        }
        ...
        const { data, error: callbackError } = await supabase.functions.invoke('paypal-callback', {
        ...
        toast({
          title: "Error",
          description: error instanceof Error ? error.message : "Failed to connect PayPal account",
          variant: "destructive",
        });
      ...
      <div className="text-center">
        {processing ? (
          <>
            ...
            <h2 className="text-xl font-semibold mb-2">Processing PayPal Connection</h2>
